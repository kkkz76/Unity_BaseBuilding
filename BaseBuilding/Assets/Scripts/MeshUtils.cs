...
public static class MeshUtils {
  ...
  //  }
    ...
    public static void AddToMeshArrays(Vector3[] vertices, Vector2[] uvs, int[] triangles, int index, Vector3 pos, float rot, Vector3 baseSize, Vector2 uv00, Vector2 uv11)
    {
        ...
        // Define the vertices for the quad in the XZ plane
        vertices[vIndex + 0] = pos + new Vector3(-baseSize.x, 0, -baseSize.z);
        vertices[vIndex + 1] = pos + new Vector3(-baseSize.x, 0, baseSize.z);
        vertices[vIndex + 2] = pos + new Vector3(baseSize.x, 0, baseSize.z);
        vertices[vIndex + 3] = pos + new Vector3(baseSize.x, 0, -baseSize.z);

        // Define the UVs for the quad
